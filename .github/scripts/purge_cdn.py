...
def main():
    try:
        ...
        # Default to https://ovodm.top/ if not provided, based on user context
        paths_env = os.environ.get("CDN_PATHS")
        if not paths_env:
            paths_env = "https://ovodm.top/"
        ...
        params = {"Paths": paths, "FlushType": "flush"}  # flush means refresh directory
